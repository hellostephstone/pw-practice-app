...
test.describe.parallel("Form Layouts page @block", () => {
  ...
  test("input fields", async ({ page }, testInfo) => {
    ...
    await usingTheGridEmailInput.pressSequentially("test2@test.com") //simulate typing and/or typing slowly , { delay: 500 }
  ...
  test("radio buttons", async ({ page }) => {
    ...
    await usingTheGridForm.getByRole("radio", { name: "Option 2" }).check({ force: true }) //using force since it is hidden
...
//freeze browser for macOS fn + F8
...
test("sliders", async ({ page }) => {
  ...
  await page.mouse.down() //click of left mouse button
